...
Feasibility Considerations: ${responses["feasibility"] || ""}
  ...
  const processMessageContent = (content: string) => {
    ...
    if (messages.length > 0 && messages[messages.length - 1].type === "evaluation") {
      // Simple section extraction for evaluation messages
      ...
      for (const line of lines) {
        ...
        if (line.includes("Assessment") || line.includes("⚠️") || 
            line.includes("Looking at your") || line.includes("• If-Then")) {
          currentSection = "assessment";
          continue;
        }
        else if (line.includes("Guidance") || line.includes("💡") || 
                line.includes("Let's") || line.includes("Here's") || 
                line.includes("template") || line.includes("IF:") || 
                line.includes("THEN:")) {
          currentSection = "guidance";
          continue;
        }
        else if (line.includes("Next Steps") || line.includes("📝") || 
                line.includes("Please revise") || line.includes("Remember")) {
