...
import { Target, ArrowLeft, BrainCircuit } from "lucide-react"
...
export default function LongTermGoalPage() {
  ...
  const handlePhaseComplete = (nextPhase?: string) => {
    ...
    if (!nextPhase) {
      // Default to short-term goal part if none provided
      router.push(`/phase4/shorttermgoal`);
      return;
    }
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <div className="flex justify-between mb-4">
            ...
            >
              <ArrowLeft className="h-4 w-4 mr-2" /> Back to Phase 4
            </Button>
          </div>
          ...
          <Card className="bg-slate-900/60 backdrop-blur-md border border-white/10 shadow-xl mb-6 max-w-4xl mx-auto w-full">
            ...
            <CardContent>
              <div className="text-white/80 mb-6">
                <p>
                  {userName ? `Welcome, ${userName}!` : "Welcome!"} Let's create a meaningful long-term learning goal that connects to your personal identity and future aspirations. I'll guide you through each step of the process.
                </p>
              </div>
