          ...
          <Card className="bg-gray-900/60 backdrop-blur-md border border-amber-500/30 shadow-xl mb-6">
            ...
            <CardContent>
              <div className="text-white/80 space-y-4 mb-6">
                <p>
                  {userName ? `Welcome ${userName}!` : "Welcome!"} In this phase, I'll help you track your progress and adjust your learning strategies:
                </p>
                ...
                <div className="bg-gray-800/50 p-4 rounded-lg border border-amber-500/20">
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      ...
                      <span>Identify effective ways to monitor your learning progress</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Sparkles className="h-5 w-5 text-amber-400 flex-shrink-0 mt-0.5" />
                      <span>Recognize which strategies are working and which need adjustment</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Sparkles className="h-5 w-5 text-amber-400 flex-shrink-0 mt-0.5" />
                      <span>Develop better self-awareness through guided reflection</span>
                    </li>
                  </ul>
                </div>
                
                <p className="text-sm text-amber-300">
                  Chat with me about your learning experience. I'll help you monitor progress and adapt your strategies.
                </p>
              </div>
...
- 🔄 **Course correction** before minor issues become major setbacks
- 🔍 **Metacognitive awareness** to become a more self-directed learner

Your monitoring & adaptation cycle:
\`\`\`
┌─────────────────┐
│ Implementation  │
└────────┬────────┘
...
Let's start by discussing how you're currently tracking your learning progress. How do you feel your current approach is serving your goals?`),
                      timestamp: new Date(),
                    }
                  ]}
